...
import { btnProperties } from './TrailingIconProperties';
import { getBtnDefaultProps } from './TrailingIconCustomThemeProvider';
import {
  ThemeProvider,
...
export const EnbdTrailingIconButton: FC<Props> = ({ label, theme, size = 'medium', backgroundColor, ...props }) => {
    return (
    <div>
